...
// /**
//  * @title WeightedTreasuryVault_withSwapCallDataNeeded
...
//  */
// contract WeightedTreasuryVault_withSwapCallDataNeeded is ERC4626, IWeightedTreasuryVault, Ownable {
...
//     function rebalance(bytes calldata data) external override onlyOwner {
//         require(adapter.execute(data), "adapter");
//         _emitState();
//     }


//     function setWeightsAndRebalance(bytes calldata data, uint256[] calldata w) external override onlyOwner {
//         _setWeights(w);
//         require(adapter.execute(data), "adapter");
//         require(!_needsRebalance(), "still off");
//         _emitState();
//     }
